...
const operationGroups = [
    {
        ...
        title: '登录与会话工具',
        description:
            '优先测试登录、注册和 Token 状态。请求层会自动从 Pinia 和 localStorage 注入认证头。',
        operations: [
            createOperation({
                key: 'login',
                title: '登录',
    ...
    },
    {
        ...
        title: '管理员接口',
        description:
            '这里覆盖 dashboard、人员、部门、人事变更、账号、公告、档案与考勤的所有管理员接口。',
        operations: [
            createOperation({
                key: 'admin-dashboard',
                title: '管理员仪表盘',
            ...
            createOperation({
                ...
                execute: (form) =>
                    adminApi.analyzeAdminDashboard(
                        undefined,
                        parseJsonText(form.paramsText, '管理员 AI 查询参数')
                    ),
            }),
            createOperation({
                ...
                execute: (form) =>
                    adminApi.getPersonList(
                        undefined,
                        parseJsonText(form.paramsText, '员工列表查询参数')
                    ),
            }),
            createOperation({
                ...
                execute: (form) =>
                    adminApi.createPerson(
                        undefined,
                        parseJsonText(form.dataText, '创建员工请求体')
                    ),
            }),
            createOperation({
            ...
            createOperation({
                ...
                execute: (form) =>
                    adminApi.updatePerson(
                        undefined,
                        form.id,
                        parseJsonText(form.dataText, '更新员工请求体')
                    ),
            }),
            createOperation({
            ...
            createOperation({
                ...
                execute: (form) =>
                    adminApi.changePersonJob(
                        undefined,
                        parseJsonText(form.dataText, '调整岗位请求体')
                    ),
            }),
            createOperation({
                ...
                execute: (form) =>
                    adminApi.changePersonState(
                        undefined,
                        parseJsonText(form.dataText, '调整状态请求体')
                    ),
            }),
            createOperation({
                ...
                execute: (form) =>
                    adminApi.changePersonDepartment(
                        undefined,
                        parseJsonText(form.dataText, '调整部门请求体')
                    ),
            }),
            createOperation({
                ...
                execute: (form) =>
                    adminApi.getDepartmentList(
                        undefined,
                        parseJsonText(form.paramsText, '部门列表查询参数')
                    ),
            }),
            createOperation({
            ...
            createOperation({
                ...
                execute: (form) =>
                    adminApi.createDepartment(
                        undefined,
                        parseJsonText(form.dataText, '创建部门请求体')
                    ),
            }),
            createOperation({
                ...
                execute: (form) =>
                    adminApi.updateDepartment(
                        undefined,
                        form.id,
                        parseJsonText(form.dataText, '更新部门请求体')
                    ),
            }),
            createOperation({
            ...
            createOperation({
                ...
                execute: (form) =>
                    adminApi.getPersonnelList(
                        undefined,
                        parseJsonText(form.paramsText, '变更列表查询参数')
                    ),
            }),
            createOperation({
                ...
                fields: [
                    { key: 'id', label: '变更 ID', type: 'text', placeholder: '请输入变更 ID' },
                ],
            ...
            createOperation({
                ...
                execute: (form) =>
                    adminApi.createPersonnel(
                        undefined,
                        parseJsonText(form.dataText, '创建变更请求体')
                    ),
            }),
            createOperation({
                ...
                execute: (form) =>
                    adminApi.approvePersonnel(
                        undefined,
                        parseJsonText(form.dataText, '审批变更请求体')
                    ),
            }),
            createOperation({
                ...
                execute: (form) =>
                    adminApi.getAccountList(
                        undefined,
                        parseJsonText(form.paramsText, '账号列表查询参数')
                    ),
            }),
            createOperation({
                ...
                execute: (form) =>
                    adminApi.createAccount(
                        undefined,
                        parseJsonText(form.dataText, '创建账号请求体')
                    ),
            }),
            createOperation({
                ...
                execute: (form) =>
                    adminApi.updateAccount(
                        undefined,
                        form.id,
                        parseJsonText(form.dataText, '更新账号请求体')
                    ),
            }),
            createOperation({
            ...
            createOperation({
                ...
                execute: (form) =>
                    adminApi.createNotice(
                        undefined,
                        parseJsonText(form.dataText, '创建公告请求体')
                    ),
            }),
            createOperation({
            ...
            createOperation({
                ...
                execute: (form) =>
                    adminApi.updateNotice(
                        undefined,
                        form.id,
                        parseJsonText(form.dataText, '更新公告请求体')
                    ),
            }),
            createOperation({
            ...
            createOperation({
                ...
                execute: (form) =>
                    adminApi.searchAttendance(
                        undefined,
                        parseJsonText(form.paramsText, '考勤查询参数')
                    ),
            }),
            createOperation({
                ...
                execute: (form) =>
                    adminApi.updateAttendance(
                        undefined,
                        form.id,
                        parseJsonText(form.dataText, '更新考勤请求体')
                    ),
            }),
            createOperation({
    ...
    },
    {
        ...
        operations: [
            ...
            createOperation({
                ...
                execute: (form) =>
                    userApi.analyzeUserDashboard(
                        undefined,
                        parseJsonText(form.paramsText, '用户 AI 查询参数')
                    ),
            }),
            createOperation({
            ...
            createOperation({
                ...
                execute: (form) =>
                    userApi.updateUserProfileById(
                        undefined,
                        form.id,
                        parseJsonText(form.dataText, '更新档案请求体')
                    ),
            }),
            createOperation({
            ...
            createOperation({
                ...
                execute: (form) =>
                    userApi.createChangeRequest(
                        undefined,
                        parseJsonText(form.dataText, '变更申请请求体')
                    ),
            }),
            createOperation({
                ...
                execute: (form) =>
                    userApi.checkIn(undefined, parseJsonText(form.dataText, '签到请求体')),
            }),
            createOperation({
                ...
                execute: (form) =>
                    userApi.checkOut(undefined, parseJsonText(form.dataText, '签退请求体')),
            }),
            createOperation({
                ...
                execute: (form) =>
                    userApi.getMyAttendance(
                        undefined,
                        parseJsonText(form.paramsText, '我的考勤查询参数')
                    ),
            }),
            createOperation({
...
const visibleGroups = computed(() =>
    operationGroups.filter((group) => group.key === activeGroup.value)
);
const tokenSummary = computed(() => {
    ...
    const preview =
        authStore.token.length > 24 ? `${authStore.token.slice(0, 24)}...` : authStore.token;
    ...
    <div class="api-lab">
        <header class="hero">
            <div class="hero__copy">
                ...
                <p class="hero__text">
                    这个页面直接基于当前 apis
                    层工作，用来验证登录态、公共接口、管理员接口和普通用户接口是否能正常联调。
                </p>
            </div>
            ...
            <div class="hero__status">
                <div class="status-card">
                    ...
                    <strong>{{
                        authStore.isAuthenticated ? '已注入 Token' : '未注入 Token'
                    }}</strong>
                    <p>{{ tokenSummary }}</p>
                </div>
            ...
            <section class="workspace__left">
                <article class="token-panel">
                    <div class="section-heading">
                        <h2>Token 控制台</h2>
                        <p>
                            这里可以手动写入、恢复或清空 token，便于切换管理员和普通用户身份测试。
                        </p>
                    </div>
                    ...
                    <div class="token-panel__actions">
                        <button
                            ...
                            type="button"
                            @click="syncManualToken"
                        >
                            写入 Token
                        </button>
                        <button class="action-button" type="button" @click="hydrateToken">
                            从缓存恢复
                        </button>
                        <button
                ...
                <nav class="group-tabs" aria-label="API 分类导航">
                    <button
                        ...
                        :class="[
                            'group-tabs__button',
                            { 'group-tabs__button--active': activeGroup === tab.key },
                        ]"
                        type="button"
