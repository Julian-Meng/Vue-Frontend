  ...
  <div class="panel-wrapper overview-layout">
    ...
    <section class="overview-row top-row">
      <article class="overview-block weather-block">
        ...
        <div v-if="weatherLoading" class="block-tip">{{ t('dashboard.overview.weatherLoading') }}</div>
        ...
        <div v-else class="weather-content">
          ...
          <p class="weather-location">{{ weather.province }} {{ weather.city }} {{ weather.district }}</p>
          <p class="weather-meta">
            <span>{{ t('dashboard.overview.windDirection') }}: {{ weather.windDirection }}</span>
            <span>{{ t('dashboard.overview.windPower') }}: {{ weather.windPower }}</span>
    ...
    <section class="overview-row notice-row overview-block">
      ...
      <div v-if="recentNotices.length === 0" class="block-tip">{{ t('dashboard.overview.noNotices') }}</div>
      <ul v-else class="notice-list">
        ...
        >
          <div class="overview-notice-main">
            ...
            <p class="overview-notice-summary">{{ notice.summary || notice.content || '-' }}</p>
          </div>
