...
function nextPage() {
    if (departments.value.length >= pageSize) {
        page.value++;
        fetchDepartments();
    }
}
...
<template>
    <div class="panel">
        ...
        <div v-else-if="departments.length === 0" class="tip">
                ...
                <tbody>
                    <tr v-for="item in departments" :key="item.id">
                        ...
                        <td>
                            ...
                            <button class="btn-link danger" @click="deleteDept(item.id)">
                                删除
                            </button>
                        </td>
                    </tr>
