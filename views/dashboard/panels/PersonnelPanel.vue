...
async function fetchList() {
    ...
    try {
        ...
        list.value = isAdmin() ? await adminApi.getPersonnelList(undefined, params) : [];
...
async function submitCreate() {
    ...
    try {
        await userApi.createChangeRequest(undefined, {
            ...
            target_dpt:
                createForm.value.target_dpt === '' ? 0 : Number(createForm.value.target_dpt),
