    ...
    <div class="panel">
        ...
        <template v-else>
            ...
            <div class="toolbar">
                ...
                <button :disabled="updating" class="btn btn-ghost" @click="submitChangeDept">
                    改部门
                </button>
            </div>
            ...
            <div class="toolbar">
                ...
                <button :disabled="updating" class="btn btn-ghost" @click="submitChangeState">
                    改状态
                </button>
            </div>
            ...
            <div class="toolbar">
                ...
                <button :disabled="updating" class="btn btn-ghost" @click="submitChangeJob">
                    改职位
                </button>
            </div>
